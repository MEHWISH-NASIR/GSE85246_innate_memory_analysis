# ============================================================
# 15j — TCGA-BRCA tumor-normal expression figure
# JAK3 + EPHB2
# ============================================================
...
stats_file <-
  "results/15_TCGA_BRCA/15b_BRCA_tumor_normal_summary.csv"

prev_file <-
  "results/15_TCGA_BRCA/15b_BRCA_prevalence_summary.csv"

outfile <-
  "TCGA_pan_cancer/BRCA/figures/01_tumor_normal_JAK3_EPHB2.png"
...
final_plot <-
  ...
  plot_annotation(
    title =
      "TCGA-BRCA: JAK3 and EPHB2 Tumor–Normal Expression",
    subtitle =
      "Breast invasive carcinoma | TCGA STAR-count RNA-seq",
    caption =
      paste0(
        "Expression unit: TPM. ",
