...
write.csv(
  ...
  file.path(
    outdir,
    "15b_BRCA_tumor_normal_summary.csv"
  ),
  row.names = FALSE
)
...
write.csv(
  ...
  file.path(
    outdir,
    "15b_BRCA_prevalence_summary.csv"
  ),
  row.names = FALSE
)
...
cat("\n========================================\n")
cat("BRCA DIRECTIONAL PREVALENCE\n")
cat("========================================\n\n")
