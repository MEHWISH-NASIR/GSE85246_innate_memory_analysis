# ============================================================
# 15e — TCGA-LUSC survival metadata audit
# Corrected:
...
cat("Downloading corrected LUSC survival metadata...\n")
...
outfile <- file.path(
  outdir,
  "17e_LUSC_survival_metadata.csv"
)
...
cat("\n========================================\n")
cat("CORRECTED LUSC SURVIVAL AUDIT\n")
cat("========================================\n\n")
