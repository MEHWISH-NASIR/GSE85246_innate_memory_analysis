...
# Collapse duplicate aliquots by median
# ------------------------------------------------------------
...
write.csv(
  ...
  file.path(
    outdir,
    "14b_BLCA_tumor_normal_summary.csv"
  ),
  row.names = FALSE
)
...
write.csv(
  ...
  file.path(
    outdir,
    "14b_BLCA_prevalence_summary.csv"
  ),
  row.names = FALSE
)
...
cat("\n========================================\n")
cat("BLCA DIRECTIONAL PREVALENCE\n")
cat("========================================\n\n")
