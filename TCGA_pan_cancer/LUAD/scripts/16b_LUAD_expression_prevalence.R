...
write.csv(
  ...
  file.path(
    outdir,
    "16b_LUAD_tumor_normal_summary.csv"
  ),
  row.names = FALSE
)
...
write.csv(
  ...
  file.path(
    outdir,
    "16b_LUAD_prevalence_summary.csv"
  ),
  row.names = FALSE
)
...
cat("\n========================================\n")
cat("LUAD DIRECTIONAL PREVALENCE\n")
cat("========================================\n\n")
