# ============================================================
# 16j — TCGA-LUAD tumor-normal expression figure
# JAK3 + EPHB2
# ============================================================
...
stats_file <-
  "results/16_TCGA_LUAD/16b_LUAD_tumor_normal_summary.csv"

prev_file <-
  "results/16_TCGA_LUAD/16b_LUAD_prevalence_summary.csv"

outfile <-
  "TCGA_pan_cancer/LUAD/figures/01_tumor_normal_JAK3_EPHB2.png"
...
final_plot <-
  ...
  plot_annotation(
    title =
      "TCGA-LUAD: JAK3 and EPHB2 Tumor–Normal Expression",
    subtitle =
      "Lung adenocarcinoma | TCGA STAR-count RNA-seq",
    caption =
      paste0(
        "Expression unit: TPM. ",
