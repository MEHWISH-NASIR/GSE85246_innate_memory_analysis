# ============================================================
# 13f — TCGA-KIRC EPHB2 EXPRESSION EXTRACTION
#
# Downloads one STAR-count file at a time, extracts EPHB2,
...
metadata_file <-
  "results/13_TCGA_EPHB2/13a_TCGA_STARCounts_metadata.csv"
...
cat("\n========================================\n")
cat("13f — TCGA-KIRC EPHB2 EXTRACTION\n")
cat("========================================\n\n")
...
# ------------------------------------------------------------
# Extract EPHB2 one sample at a time
# ------------------------------------------------------------
