# ============================================================
# 15e — TCGA-BRCA survival metadata audit
# Corrected:
...
cat("Downloading corrected BRCA survival metadata...\n")
...
outfile <- file.path(
  outdir,
  "15e_BRCA_survival_metadata.csv"
)
...
cat("\n========================================\n")
cat("CORRECTED BRCA SURVIVAL AUDIT\n")
cat("========================================\n\n")
