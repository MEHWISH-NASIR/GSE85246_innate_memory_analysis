# ============================================================
# 16k — TCGA-LUAD early-stage tumor vs normal analysis
#
...
write.csv(
  ...
  file.path(
    outdir,
    "16k_LUAD_stageI_II_vs_normal_sensitivity.csv"
  ),
  row.names = FALSE
)
...
cat("\n========================================\n")
cat("LUAD EARLY-STAGE PRIMARY ANALYSIS\n")
...
cat("\n========================================\n")
cat("LUAD EARLY-STAGE SENSITIVITY\n")
