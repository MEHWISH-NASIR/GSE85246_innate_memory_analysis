# ============================================================
# 16g — TCGA-LUAD survival analysis
# JAK3 + EPHB2
#
# Primary predictor:
...
for (gene in genes) {
  ...
  continuous_results[[gene]] <- data.frame(
    ...
    Grade_adjustment =
      "Unavailable: TCGA-LUAD GDC tumor_grade field unpopulated",
...
write.csv(
  ...
  file.path(
    outdir,
    "16g_LUAD_survival_association.csv"
  ),
  row.names = FALSE
)
...
write.csv(
  ...
  file.path(
    outdir,
    "16g_LUAD_survival_group_association.csv"
  ),
  row.names = FALSE
)
...
cat("\n========================================\n")
cat("LUAD CONTINUOUS SURVIVAL ASSOCIATION\n")
cat("========================================\n\n")
...
cat("\n========================================\n")
cat("LUAD NORMAL-DERIVED GROUP SURVIVAL\n")
cat("========================================\n\n")
...
cat("\n========================================\n")
cat("LUAD SURVIVAL GROUP SUMMARY\n")
cat("========================================\n\n")
