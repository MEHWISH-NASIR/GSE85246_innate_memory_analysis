# ============================================================
# 14h — TCGA-BLCA early-stage tumor vs normal analysis
#
...
write.csv(
  ...
  file.path(
    outdir,
    "14h_BLCA_stageI_II_vs_normal_sensitivity.csv"
  ),
  row.names = FALSE
)
...
cat("\n========================================\n")
cat("BLCA EARLY-STAGE PRIMARY ANALYSIS\n")
...
cat("\n========================================\n")
cat("BLCA EARLY-STAGE SENSITIVITY\n")
