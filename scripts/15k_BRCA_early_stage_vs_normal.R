# ============================================================
# 15k — TCGA-BRCA early-stage tumor vs normal analysis
#
...
write.csv(
  ...
  file.path(
    outdir,
    "15k_BRCA_stageI_II_vs_normal_sensitivity.csv"
  ),
  row.names = FALSE
)
...
cat("\n========================================\n")
cat("BRCA EARLY-STAGE PRIMARY ANALYSIS\n")
...
cat("\n========================================\n")
cat("BRCA EARLY-STAGE SENSITIVITY\n")
